...
# time complexity is O(n) b/c it goes through the loop n times based on the length of word inputted.

# space complexity is O(1) b/c the storage does not increase in size based on the input.
